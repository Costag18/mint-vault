          ...
          if (item.isCenter) {
            return (
              <Link
                key={item.href}
                href={item.href}
                className="flex flex-col items-center justify-center gap-0.5 px-4 py-1.5 rounded-xl bg-gradient-to-b from-primary-container to-background text-white scale-110"
              >
